<template>
  <section>
    <el-form :inline="true" class="searchForm" style="width: 60%;">
      ...
      <el-form-item label="入驻时间：" v-if="condition == 2">
      ...
      <el-form-item label="交易金额：" v-if="condition == 3">
        <el-input v-model="amtMin" placeholder="最低金额"></el-input>
      </el-form-item>
      <el-form-item v-if="condition == 3">
        <el-input v-model="amtMax" placeholder="最高金额"></el-input>
      </el-form-item>
		</el-form>
...
<script>
import { ShopMessage } from '../../api/api';
