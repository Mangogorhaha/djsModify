<template>
  <section>
    <el-row class="dialog_title">
      <el-col :span="12">邀请好友列表</el-col>
      <el-col :span="6">人数：<span class="FF6600">{{dataList.count_ivt}}</span></el-col>
    ...
    <el-table :data="tableList.slice((page-1)*item,page*item)" border highlight-current-row max-height="560" @selection-change="selsChange">
      ...
      <el-table-column prop="mobile" key="1" label="手机号码" min-width="140">
      </el-table-column>
      <el-table-column prop="wechat_number" key="2" label="微信号码" min-width="140">
      </el-table-column>
      <el-table-column prop="token_award" key="3" label="token奖励" min-width="140">
      </el-table-column>
      <el-table-column prop="amount_consumed" key="4" label="已消费金额" min-width="140">
      </el-table-column>
    </el-table>
